...
<p>Модуль не работает если авторизован администратор сайта ! (Администраторам всегда доверяем)</p>
<p>Возможности:
	<ul>
...
<p>Если стандартные события Bitrix не подходят или Ваши формы не используют события</p>
<pre>
...
<p>Если нужны дополнительные проверки или действия после проверки</p>
<pre>
...
<p>Добавить каптчу к определенной форме, то где либо в некешируемой (!) области вывести (так как скрипт гшенерируется каждый раз новый)</p>
